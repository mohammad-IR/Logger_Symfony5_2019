...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'username', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'applications', '' . "\0" . 'App\\Entity\\User' . "\0" . 'userPackages', '' . "\0" . 'App\\Entity\\User' . "\0" . 'number_log_now', '' . "\0" . 'App\\Entity\\User' . "\0" . 'validation', '' . "\0" . 'App\\Entity\\User' . "\0" . 'comments'];
        }
     ...
     * {@inheritDoc}
     */
    public function addUserPackage(\App\Entity\UserPackage $userPackage): \App\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function removeUserPackage(\App\Entity\UserPackage $userPackage): \App\Entity\User
    {
    ...
    public function getNumberLogNow(): ?int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumberLogNow', []);

        return parent::getNumberLogNow();
    }

    /**
     * {@inheritDoc}
     */
    public function setNumberLogNow(int $number_log_now): \App\Entity\User
    {
