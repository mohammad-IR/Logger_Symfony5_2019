 ...
 */
class getLoggerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LoggerRepository' shared autowired service.
     *
     * @return \App\Repository\LoggerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LoggerRepository.php';

        return $container->privates['App\\Repository\\LoggerRepository'] = new \App\Repository\LoggerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
