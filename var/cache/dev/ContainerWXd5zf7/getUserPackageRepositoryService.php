 ...
 */
class getUserPackageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserPackageRepository' shared autowired service.
     *
     * @return \App\Repository\UserPackageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserPackageRepository.php';

        return $container->privates['App\\Repository\\UserPackageRepository'] = new \App\Repository\UserPackageRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
